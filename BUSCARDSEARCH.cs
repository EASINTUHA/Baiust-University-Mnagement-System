...
namespace BAIUST
{
    public partial class BUSCARDSEARCH : Form
    {
        public BUSCARDSEARCH()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "Select * from bus where Student_id =" + textBoxID.Text + " ";
        ...
        private void BUSCARDSEARCH_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection();
